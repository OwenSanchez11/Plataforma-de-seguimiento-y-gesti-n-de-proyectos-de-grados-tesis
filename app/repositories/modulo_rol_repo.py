...
class ModuloRolRepository:
    ...
    def obtenerModulosRol(self):
        ...
        try:
            ...
            print("Error al obtener módulos por rol:", e)
            return []
    ...
    def obtenerModuloRolPorId(self, id_modulo_rol: int):
        ...
        try:
            ...
            print("Error al obtener módulo por rol:", e)
            return None
    ...
    def crearModuloRol(self, modulo_rol: ModuloRol):
        ...
        try:
            ...
            print("Error al crear módulo por rol:", e)
            return None
    ...
    def eliminarModuloRol(self, id_modulo_rol: int):
        ...
        try:
            ...
            print("Error al eliminar módulo por rol:", e)
            return None